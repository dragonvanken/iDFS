...
class MFCStub(object):
  ...
  def __init__(self, channel):
    ...
    self.getTrunkInfoAndAllocatedDataServer = channel.unary_stream(
        '/MFC/getTrunkInfoAndAllocatedDataServer',
        request_serializer=MasterForClient__pb2.getTrunkInfoAndAllocatedDataServerRequest.SerializeToString,
        response_deserializer=MasterForClient__pb2.Str.FromString,
        )
...
class MFCServicer(object):
  ...
  def getTrunkInfoAndAllocatedDataServer(self, request, context):
    """事务：文件上传
...
def add_MFCServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'getTrunkInfoAndAllocatedDataServer': grpc.unary_stream_rpc_method_handler(
          servicer.getTrunkInfoAndAllocatedDataServer,
          request_deserializer=MasterForClient__pb2.getTrunkInfoAndAllocatedDataServerRequest.FromString,
          response_serializer=MasterForClient__pb2.Str.SerializeToString,
      ),
  }
